from ocelot.cpbd.elements import Drift, Hcor, Marker, Monitor, Quadrupole, RBend, SBend, Sextupole, Vcor
...
sweep_2119_tld = RBend(
    l=0.64, angle=0.0, e1=0.0, e2=0.0, gap=0, tilt=-1.570796327, fint=0.0, fintx=0.0, eid='SWEEP.2119.TLD'
)
