...
# bending magnets
be_2546_t3 = SBend(
    l=2.5, angle=0.0218803, e1=0.01094015, e2=0.01094015, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2546.T3'
)
be_2566_t3 = SBend(
    l=2.5, angle=0.0218803, e1=0.01094015, e2=0.01094015, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2566.T3'
)
