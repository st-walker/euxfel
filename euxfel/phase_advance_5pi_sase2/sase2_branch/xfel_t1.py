...
# qk_2027_tl = SBend(l=1.0552, angle=1.0552*0.09035960007960576*dy,
# k1=0.09035960007960576, e1=0.002244, e2=0, tilt=1.570796, eid='QK.2027.TL')
# qk_2027_tl = SBend(l=1.0552, angle=1.0552*0.09035960007960576*d,
# k1=0.09035960007960576/., e1=-0.005, e2=0.006, tilt=1.570796-0.21321543,
# eid='QK.2027.TL')
...
# bending magnets
bz_2025_t1 = SBend(
    l=1.0, angle=-0.00550002773, e1=0.0, e2=-0.005500028, gap=0, tilt=0.21321543, fint=0.0, fintx=0.0, eid='BZ.2025.T1'
)
bz_2030_t1 = SBend(
    l=1.0,
    angle=-0.00550002773,
...
bd_2050_t1 = SBend(
    l=1.0, angle=0.00303654925, e1=0.001518275, e2=0.001518275, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BD.2050.T1'
)
bd_2062_t1 = SBend(
    l=1.0, angle=0.00303654925, e1=0.001518275, e2=0.001518275, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BD.2062.T1'
)
bd_2077_t1 = SBend(
    l=1.0,
    angle=-0.005827964456,
    e1=-0.002913982,
    e2=-0.002913982,
    gap=0,
    tilt=0.0,
