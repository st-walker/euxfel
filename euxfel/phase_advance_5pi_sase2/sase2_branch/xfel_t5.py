...
# bending magnets
be_2821_t5 = SBend(
    l=2.5, angle=-0.0169497, e1=-0.00847485, e2=-0.00847485, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2821.T5'
)
be_2841_t5 = SBend(
    l=2.5, angle=-0.0169497, e1=-0.00847485, e2=-0.00847485, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2841.T5'
)
