...
# bending magnets
bg_467_b2d = SBend(
    l=1.5971, angle=0.2094395102, e1=0.0, e2=0.0, gap=0, tilt=1.570796327, fint=0.0, fintx=0.0, eid='BG.467.B2D'
)
bg_474_b2d = SBend(
    l=1.5971, angle=-0.2094395102, e1=0.0, e2=0.0, gap=0, tilt=1.570796327, fint=0.0, fintx=0.0, eid='BG.474.B2D'
)
