...
from ocelot.cpbd.elements import Drift, Hcor, Marker, Monitor, Quadrupole, SBend, Sextupole, Undulator, Vcor
...
# bending magnets
be_2584_t4 = SBend(
    l=2.5, angle=0.0115035, e1=0.00575175, e2=0.00575175, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2584.T4'
)
be_2604_t4 = SBend(
    l=2.5, angle=0.0115035, e1=0.00575175, e2=0.00575175, gap=0, tilt=0.0, fint=0.0, fintx=0.0, eid='BE.2604.T4'
)
...
d1_img2 = Drift(l=0.6718 / 2.0)
d2_img2 = Drift(l=0.6718 / 2.0)
