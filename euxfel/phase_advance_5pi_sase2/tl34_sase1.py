...
from ocelot.cpbd.elements import Drift, Hcor, Marker, Monitor, Quadrupole, Vcor
...
# qf_2012_tl = SBend(l=0.5321, angle=-0.5321*0.1791908476*dy, k1=-0.1791908476,
#                    e1=0.0005095, e2=0.0010813, tilt=1.570796, eid='QF.2012.TL')
